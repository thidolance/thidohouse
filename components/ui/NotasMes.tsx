...
export default function NotasMes({ mes, ano }: Props) {
  ...
  return (
    <>
      {/* Painel */}
      {aberto && (
        <div className="fixed bottom-20 right-4 z-50 w-80 bg-zinc-900 rounded-2xl shadow-2xl border border-purple-500/30 flex flex-col overflow-hidden animate-in slide-in-from-bottom-4 duration-200">
          {/* Header */}
          <div className="flex items-center justify-between px-4 py-3 bg-gradient-to-r from-purple-600 to-violet-700 text-white">
          ...
          <div className="flex flex-col flex-1 p-3 gap-2">
            {loading ? (
              ...
              <textarea
                ...
                rows={8}
                className="w-full resize-none rounded-xl border border-zinc-800 bg-zinc-950 px-3 py-2.5 text-sm text-zinc-200 placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent transition"
              />
            )}
